...
class FXRates:
    ...
    def rate(self, lhs: Ccy, rhs: Ccy) -> Optional[DualTypes]: ...
...
class Dual(_DualOps):
    ...
    def vars_from(
        ...
        dual: Sequence[float] #Sequence[float] | Arr1dF64,
    ) -> "Dual": ...
...
class Dual2(_DualOps):
    ...
    def vars_from(
        ...
        dual: list[float], # list[float] | Arr1dF64,
        dual2: list[float] # list[float] | Arr1dF64,
    ) -> "Dual2": ...
